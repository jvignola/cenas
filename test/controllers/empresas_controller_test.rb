...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { nombre: @empresa.nombre, pais: @empresa.pais } }, as: :json
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { nombre: @empresa.nombre, pais: @empresa.pais } }, as: :json
    assert_response 200
  end
